...
`animations/manim_style_geometry.mp4` es opcional y se puede generar localmente con
`python scripts/render_manim_style_geometry.py`; no es requisito para la entrega ni
